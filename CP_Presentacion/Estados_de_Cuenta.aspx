<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Estados_de_Cuenta.aspx.cs" Inherits="CP_Presentacion.Estados_de_Cuenta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center; width: 500px">ESTADOS DE CUENTA - UNIFICADO</h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary" style="height: 190px;">
                    <div class="box-header with-border center">
                        <p style="font-size: 12px; font-weight: bold;" class="box-title text-danger">BUSQUEDA POR UBICACIÓN Y LUGARES DE TRABAJO</p>
                    </div>
                    <div class="container">
                    </div>
                    <div class="box-body">
            ...
            <div class="col-md-3">
                <div class="box box-primary" style="height: 190px;">
                    <div class="box-header with-border center">
                        <p style="font-size: 12px; font-weight: bold;" class="box-title text-danger">BUSQUEDA POR ASOCIADO</p>
                    </div>
                    <div class="container">
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="txtBuscarAsociado" class="form-control" type="number">
            ...
            <div class="col-md-3">
                <div class="box box-primary" style="height: 190px;">
                    <div class="box-header with-border center">
                        <p style="font-size: 12px; font-weight: bold;" class="box-title text-danger">OPCIONES DEL MÓDULO</p>
                    </div>
                    <div class="container">
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                <label for="conEmail" class="btn btn-warning">
                                    <span class="glyphicon glyphicon-ok"></span>
                                    <span></span>
                                </label>
                                <label for="conEmail" class="btn btn-default active">
                                    Buscar solo asociados con Email&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-envelope"></i>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                <label for="borrarDirectorio" class="btn btn-warning">
                                    <span class="glyphicon glyphicon-ok"></span>
                                    <span></span>
                                </label>
                                <label for="borrarDirectorio" class="btn btn-default active">
                                    Eliminar los archivos del Directorio&nbsp;&nbsp;&nbsp;<i class="fa fa-trash"></i>
                                </label>
                            </div>
                        </div>
                        <div class="form-group has-success">
                            <label class="text-black"><i class="fa fa-2x fa-search"></i>&nbsp; BUSCAR A PARTIR DEL CÓDIGO CLIENTE #:</label>
                            <div class="input-group">
                                <span class="input-group-addon" id="AddonUltimoCodCliente">
                                    <input type="checkbox" id="chkUltimoCodCliente">
                                </span>
                                <input type="number" class="form-control" id="txtUltimoCodCliente" style="width: 72%" placeholder="Último Código de Cliente..." disabled>
                            </div>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <!-- JS Estado de Cuenta -->
    <script src="v0005/js/estadodecuenta_v2.min.js" type="text/javascript"></script>
    <!-- JS PSBANK Asociados -->
    <script src="v0005/js/psbank_asociados_v2.2.min.js" type="text/javascript"></script>
    <!-- JS Barra Progreso -->
