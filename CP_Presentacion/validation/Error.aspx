...
<body class="sign error-page-wrapper background-color background-image">
    ...
    <div class="text-container" style="padding-bottom: 30px;">
        ...
        <div class="buttons-container">
            <a class="border-button" href="http://reportmanager/"><span class="fa fa-home"></span>VOLVER</a>
            <a class="border-button" href="mailto:helpdesk@coopecaja.fi.cr" target="_blank"><span class="fa fa-warning"></span>REPORTAR ERROR</a>
        </div>
    </div>
